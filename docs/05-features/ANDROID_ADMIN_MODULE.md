# Módulo Admin Móvil - App Android

**Estado:** ✅ IMPLEMENTADO

**Descripción:** Módulo Admin móvil completo para la app Android que permite a los administradores gestionar notificaciones, dispositivos y configuraciones desde sus dispositivos móviles.
