...
- **Reverb Setup**: Ver `infra/docker/environments/production/REVERB_SETUP.md`
- **Docker Infrastructure**: Ver `docs/02-deployment/DOCKER.md`
- **Deployment Guide General**: Ver `docs/02-deployment/DEPLOYMENT.md`
- **Update Checklist**: Ver `docs/06-operations/UPDATE_CHECKLIST.md`
